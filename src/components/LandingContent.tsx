    ...
    <div className="max-w-7xl mx-auto px-4 md:px-6 py-16 md:py-24 pb-32 overflow-hidden">
      ...
      >
        <motion.h2
          ...
          className="text-4xl md:text-7xl font-extrabold text-primary mb-6 font-georgia leading-tight"
        >
          One Link,
          <br className="md:hidden" /> Endless Possibilities
        </motion.h2>
        <motion.p
          variants={itemVariants}
          className="text-lg md:text-xl text-brown/70 max-w-2xl mx-auto font-medium leading-relaxed mb-10"
        >
          Surn.me helps you manage your links with style. Minimalist link
          shortener and beautiful Link Trees in one platform.
        </motion.p>
        <motion.div
          variants={itemVariants}
        ...
        >
          <Button
            asChild
            className="w-full sm:w-auto h-14 px-10 bg-primary text-[#F7F5E6] hover:bg-primary/90 rounded-2xl font-bold text-lg shadow-xl shadow-primary/20 transition-all hover:scale-[1.02]"
          >
          ...
          <Button
            asChild
            variant="outline"
            className="w-full sm:w-auto h-14 px-10 border-2 border-[#DCC9A6] text-brown hover:bg-[#DCC9A6]/10 rounded-2xl font-bold text-lg transition-all"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="order-2 lg:order-1">
            ...
            <p className="text-lg text-brown/70 mb-8 leading-relaxed font-medium">
              Stop sharing multiple links. Create a stunning landing page that
              houses everything you do. From social media profiles to your
              latest projects, showcase it all with elegance.
            </p>

            <ul className="space-y-4 mb-10">
              {[
                {
                  icon: <IconPalette className="text-primary" />,
                  text: "Custom themes and colors to match your brand",
                },
                {
                  icon: <IconShare className="text-primary" />,
                  text: "Easily shareable short URL (surn.me/f/yourname)",
                },
                {
                  icon: <IconClick className="text-primary" />,
                  text: "Interactive icons for all major platforms",
                },
              ].map((item, i) => (
                <motion.li
                  key={i}
            ...
            <Button
              asChild
              variant="link"
              className="text-primary font-bold text-lg p-0 hover:no-underline group"
            >
      ...
      >
        {features.map((feature, index) => (
          ...
          >
            ...
            <h3 className="text-xl font-bold text-primary mb-3 font-georgia">
              {feature.title}
            </h3>
      ...
      >
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          <h2 className="text-3xl md:text-5xl font-bold mb-6 font-georgia leading-tight">
            Ready to Shorten Your Links?
          </h2>
          <p className="text-lg md:text-xl opacity-80 mb-10 font-medium leading-relaxed">
            Join hundreds of users who are already using surn.me for their
            branding needs. Clean, fast, and professional.
          </p>
          <div className="flex justify-center">
            <Button
              asChild
              className="h-14 px-12 bg-white text-primary hover:bg-[#F7F5E6] rounded-2xl font-bold text-lg shadow-xl transition-all hover:scale-[1.05] whitespace-normal sm:whitespace-nowrap min-h-14 py-4"
            >
