...
export default function RegisterPage() {
  ...
  return (
    ...
    >
      ...
      >
        <Link href="/" className="bg-[#F7F5E6] rounded-full p-4 border border-[#DCC9A6] shadow-2xl shadow-brown/10">
          <Image
            src="/logo.svg"
            alt="surn.me"
            width={120}
      ...
      <div className="bg-[#F7F5E6] rounded-[40px] p-8 md:p-12 border border-[#DCC9A6] shadow-2xl shadow-brown/10">
        <div className="mb-10 text-center md:text-left">
          <h1 className="text-3xl md:text-4xl font-bold text-primary mb-3 font-georgia">Register</h1>
          <p className="text-brown/60 font-medium">Create your surn.me account</p>
        </div>
        ...
        {success ? (
          ...
          >
            <h2 className="text-2xl font-bold text-green-800 font-georgia mb-3">Check Your Email!</h2>
            ...
            <Button asChild className="w-full h-14 bg-primary text-[#F7F5E6] hover:bg-primary/90 rounded-2xl font-bold text-lg shadow-lg">
          ...
          <>
            <form onSubmit={handleRegister} className="space-y-6">
              <div className="space-y-2">
                <Label htmlFor="name" className="text-brown font-semibold ml-1">Full Name</Label>
                <Input
                  id="name"
                  name="name"
                  type="text"
              ...
              <div className="space-y-2">
                <Label htmlFor="email" className="text-brown font-semibold ml-1">Email</Label>
                <Input
                  id="email"
                  name="email"
                  type="email"
              ...
              <div className="space-y-2">
                <Label htmlFor="password" title="Password" className="text-brown font-semibold ml-1">Password</Label>
                <Input
                  id="password"
                  name="password"
                  type="password"
