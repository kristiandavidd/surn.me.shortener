    ...
    >
      ...
      <div className="bg-[#F7F5E6] rounded-[40px] p-8 md:p-12 border border-[#DCC9A6] shadow-2xl shadow-brown/10">
        <div className="mb-10 text-center md:text-left">
          <h1 className="text-3xl md:text-4xl font-bold text-primary mb-3 font-georgia">Login</h1>
          <p className="text-brown/60 font-medium">Sign in to your surn.me account</p>
        </div>
